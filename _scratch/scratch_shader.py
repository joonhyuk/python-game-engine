...
class MyWindow(arcade.Window):
    ...
    def __init__(self):
        ...
        file = open("_scratch/shaders/compute_shader.glsl")
        compute_shader_source = file.read()
        file = open("_scratch/shaders/vertex_shader.glsl")
        vertex_shader_source = file.read()
        file = open("_scratch/shaders/fragment_shader.glsl")
        fragment_shader_source = file.read()
        file = open("_scratch/shaders/geometry_shader.glsl")
