...
class MyWindow(arcade.Window):
    ...
    def setup(self):
        ...
        self.movable_list = arcade.SpriteList()
        ...
        # 이동하는 동전
        moving_coin = arcade.Sprite(items[2], SPRITE_SCALING_PLAYER)
        moving_coin.position = (500, 500)
        self.movable_list.append(moving_coin)
        ...
        self.physics_engine.add_sprite_list(self.movable_list, 
                                            mass = 1,
                                            friction=1.0,
                                            elasticity=1.0,
                                            damping=1.0,
