...
class MyGame(arcade.Window):
    ...
    def on_update(self, delta_time):
        ...
        for coin in self.coin_list:
            ...
            coin_hit = arcade.check_for_collision_with_list(coin, self.coin_list)
            # for coined in coin_hit:
            if len(coin_hit) > 0:
                coin.velocity = list(i * -1 for i in coin.velocity)
                # coin.velocity = Vector(coin.velocity) * -1
