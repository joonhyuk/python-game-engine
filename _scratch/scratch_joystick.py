...
class Player(arcade.Sprite):
    ...
    def dump_joystick(self, joy:arcade.joysticks.Joystick):
        print("========== {}".format(joy))
    ...
    def update(self):
        ...
        if self.joystick:
            self.dump_joystick(self.joystick)
            
            self.velocity = [self.joystick.x * MOVEMENT_SPEED, -self.joystick.y * MOVEMENT_SPEED]
            # x-axis
